...
validY = trainY[700001:730001]
trainX = trainX[0:700001]
trainY = trainY[0:700001]
print "starting training"
loading = False
if loading == False:
	model = NN.neuralNetwork([numberOfFeatures,numberOfFeatures,numberOfClasses])
else:
	print "---- loading model ----"
	with open('1layer.pkl', 'rb') as input:
...
while(epochs<10):
	...
	if epochs%13 == 0:
		...
		with open('1layer.pkl', 'wb') as output:
